...
final class UiComponentConfig {
    ...
    static final float LIVE_ROOM_TASK_RANK_SCROLL_SWIPE_END_Y_RATIO = 0.72f;
    static final float LIVE_ROOM_TASK_RANK_SCROLL_SWIPE_EXTRA_DISTANCE_RATIO = 0.02f;
    ...
    static final float LIVE_ROOM_TASK_RANK_SCROLL_SWIPE_MIN_DISTANCE_RATIO = 0.09f;
    static final int LIVE_ROOM_TASK_RANK_SCROLL_ACTION_COMPENSATE_MAX_TRY = 0;
